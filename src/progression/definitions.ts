...
export const COSMETICS: readonly CosmeticDefinition[] = [
  { id: "cardback-oathguard-standard", name: "Oathguard Standard", kind: "cardback", description: "Royal blue with a gold sigil.", swatch: "from-oath-blue to-oath-blue-deep" },
  { id: "cardback-beacon", name: "Beacon Weave", kind: "cardback", description: "Cyan crystal light through relic glass.", swatch: "from-oath-cyan to-oath-blue" },
  { id: "cardback-hollow-crown", name: "Fractured Crown", kind: "cardback", description: "Blackglass with a violet fracture.", swatch: "from-hollow-violet to-hollow-black" },
  { id: "cardback-gilded-oath", name: "Gilded Oath", kind: "cardback", description: "Silver filigree over deep gold.", swatch: "from-oath-gold to-oath-silver" },
  { id: "theme-oathguard", name: "Oathguard Hall", kind: "theme", description: "The default hopeful, high-contrast theme.", swatch: "from-oath-blue-deep to-background" },
  { id: "theme-archive", name: "Truthwarden Archive", kind: "theme", description: "Lantern-lit reading room tones.", swatch: "from-oath-cyan to-oath-blue-deep" },
  { id: "theme-dawnwatch", name: "Dawnwatch Ridge", kind: "theme", description: "First-light gold over cold stone.", swatch: "from-oath-gold to-oath-blue-deep" },
  { id: "badge-sworn-in", name: "Sworn In", kind: "badge", description: "Completed the full tutorial.", swatch: "from-oath-cyan to-oath-gold" },
  { id: "badge-gatekeeper", name: "Gatekeeper", kind: "badge", description: "Won a cooperative match.", swatch: "from-oath-blue to-oath-cyan" },
  { id: "badge-duellist", name: "Duellist", kind: "badge", description: "Won an Oathguard Trials match.", swatch: "from-oath-gold to-oath-cyan" },
  { id: "badge-crown-breaker", name: "Crown Breaker", kind: "badge", description: "Defeated every Quick Boss.", swatch: "from-hollow-violet to-oath-gold" },
];
